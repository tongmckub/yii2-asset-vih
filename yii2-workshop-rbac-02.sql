...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2015 at 12:08 PM
...
--
-- Database: `yii2-workshop-rbac-02`
--
...
(7, 's', 's', 1, 's', 1442546493, 7, 1442546493, 7);
...
CREATE TABLE IF NOT EXISTS `computer_vih` (
  ...
  `asset_code` varchar(17) COLLATE utf8_unicode_ci NOT NULL,
  `division_id` int(3) NOT NULL,
  `of_user` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `serial_no` varchar(24) COLLATE utf8_unicode_ci NOT NULL,
  `computer_localtion` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `division`
  MODIFY `division_id` int(3) NOT NULL AUTO_INCREMENT COMMENT 'รหัสฝ่าย';
--
-- AUTO_INCREMENT for table `software`
--
ALTER TABLE `software`
  MODIFY `software_id` int(3) NOT NULL AUTO_INCREMENT COMMENT 'เลขที่ซอฟต์แวร์',AUTO_INCREMENT=2;
--
